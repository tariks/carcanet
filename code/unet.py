# UNet model. Conversion from Keras to PyTorch 

import torch
import numpy as np
import torch.nn as nn
from keras.layers import ReLU
from baseline_aug import get_unet # baseline_aug code from origin (https://github.com/jocicmarko/ultrasound-nerve-segmentation)


def UNet(do=0, activation=nn.ReLU):
...
model, crit, opt = UNet()  # assuming the PyTorch model is defined as above
...
torch.save(model.state_dict(), "pretrained.state_dict.pt")
